...
//
// /// ═══════════════════════════════════════════════════════════════
// /// شاشة نقاط الولاء - النسخة النهائية
// /// بدون استبدال، فقط المعالم والكوبونات التلقائية
// /// ═══════════════════════════════════════════════════════════════
...
//     print('🎯 Building Milestones Tab');
//     print('   Milestones count: ${provider.milestones.length}');
//     print('   Is loading: ${provider.isLoadingMilestones}');
//
...
//     ],
//     ),
//                     // تكملة _buildMilestoneCard من الجزء السابق
//
//                     if (!isAchieved) ...[
...
//     print('🎫 Building Coupons Tab');
//     print('   Coupons count: ${provider.coupons.length}');
//     print('   Available: ${provider.availableCouponsCount}');
//     print('   Used: ${provider.usedCouponsCount}');
//     print('   Is loading: ${provider.isLoadingCoupons}');
//
...
//           child: Stack(
//             children: [
//               // ✅ إضافة شريط "مستخدم" إذا كان مستخدماً
//               if (isUsed)
//                 Positioned(
//                   top: 20.h,
//                   right: -30.w,
...
//               ),
//
//               // ✅ إضافة Overlay للكوبونات المستخدمة/المنتهية
//               if (isUsed || isExpired)
//                 Positioned.fill(
//                   child: Container(
//                     decoration: BoxDecoration(
...
//                                     color: Colors.white,
//                                     letterSpacing: 2,
//                                     // ✅ إضافة خط في المنتصف إذا كان مستخدماً
//                                     decoration: isUsed
...
//                             ),
//                           ),
//                           // ✅ إخفاء زر النسخ إذا كان مستخدماً أو منتهياً
//                           if (!isUsed && !isExpired)
//                             Material(
//                               color: Colors.transparent,
//                               child: InkWell(
...
//                           child: Text(
//                             isUsed
//                                 ? 'تم الاستخدام في ${coupon.usedAt != null ? DateFormat('dd/MM/yyyy', 'ar').format(coupon.usedAt!) : 'تاريخ غير محدد'}'
//                                 : isExpired
